...
## ✨ 2.0.9 Adds Multi-Page Support [PR #685](https://jordanbourbonnais.com/pull/685)
- Adds Widgets for AdGuard

## ✨ 2.0.9 Adds Multi-Page Support [PR #663](https://jordanbourbonnais.com/pull/663)
...
## ✨ 2.0.8 Adds Multi-Page Support [PR #617](https://jordanbourbonnais.com/pull/617)
...
## ⚡️ 2.0.7 Improves handling of Sections and Items [PR #595](https://jordanbourbonnais.com/pull/595)
...
## 🐛 2.0.6 Fixes user requested issues [PR #557](https://jordanbourbonnais.com/pull/557)
...
## ✨ 2.0.4 - Dynamic Config Loading [PR #528](https://jordanbourbonnais.com/pull/528)
- `conf.yml` is now loaded dynamically and the app now only needs a browser refresh on config change, not a full rebuild!

## 🐛 2.0.3 - Bug Fixes [PR #488](https://jordanbourbonnais.com/pull/488)
...
## ⬆️ 2.0.2 - Dependency Updates [PR #471](https://jordanbourbonnais.com/pull/471)
- Updates Alpine version for main Dockerfile
- Updates node_modules to latest stable versions

## 🐛 2.0.1 - Fixes Section Height [PR #462](https://jordanbourbonnais.com/pull/462)
...
## ⚡️ 2.0.0 - Small Fixes and Docker Multi-Arch Build [PR #451](https://jordanbourbonnais.com/pull/451)
...
## 💄 1.9.9 - Minor UI + Docs Updates [PR #431](https://jordanbourbonnais.com/pull/431)
- Improved theme support for widgets
- Better widget layout in Workspace and Minimal views
- Updates lots of the docs

## ✨ 1.9.8 - More Widgets and Widget Improvements [PR #425](https://jordanbourbonnais.com/pull/425)
...
## 🐛 1.9.7 - Minor UI Editor Bug fixes [PR #416](https://jordanbourbonnais.com/pull/416)
- Fixes unable to edit item bug (#415)
- Fixes unable to add new app bug (#390)
- Fixes nav links visibility (#389)

## ⚡️ 1.9.6 - Adds Proxy Support for Widget Requests [PR #392](https://jordanbourbonnais.com/pull/392)
...
## 🐛 1.9.5 - Bug fixes and Minor Improvements [PR #388](https://jordanbourbonnais.com/pull/388)
- Adds icon.horse to supported favicon APIs
- Fixes tile move bug, Re: #366
- Fixes save items without title bug, Re: #377

## ✨ 1.9.4 - Widget Support [PR #382](https://jordanbourbonnais.com/pull/382)
...
## ⚡️ 1.9.2 - Native SSL Support + Performance Improvements [PR #326](https://jordanbourbonnais.com/pull/326)
...
## 💄 1.9.1 - Editor and Theming Fixes and Improvements [PR #319](https://jordanbourbonnais.com/pull/319)
...
## 🐳 1.9.0 - Alpha of Dashy-Lite Docker Container [PR #306](https://jordanbourbonnais.com/pull/306)
...
## ✨ 1.8.9 - All New Interactive Config Editor [PR #298](https://jordanbourbonnais.com/pull/298)
...
## ✨ 1.8.8 - Improved Item Targets [PR #292](https://jordanbourbonnais.com/pull/292)
...
## ⚡️ 1.8.7 - Bug Fixes and Improvements [PR #273](https://jordanbourbonnais.com/pull/273)
...
## ⚡️ 1.8.6 - Implementation of VueX [PR: #271](https://jordanbourbonnais.com/pull/271)
...
## 💄 1.8.5 - Lots of Requested UI Improvements [PR #261](https://jordanbourbonnais.com/pull/261)
...
## ✨ 1.8.4 - Custom Error Pages [PR #257](https://jordanbourbonnais.com/pull/257)
- Creates a 404 Not Found page
- Routes any missing views to the 404 page

## ⚡️ 1.8.3 - Improved UX for Initial Load [PR #238](https://jordanbourbonnais.com/pull/238)
...
## ✨ 1.8.2 - Serverless Functions for Netlify Instances [PR #235](https://jordanbourbonnais.com/pull/235)
...
## 🩹 1.8.1 - Additional Languages, Bug Fix, and more [PR #234](https://jordanbourbonnais.com/pull/234)
...
## ⚡️ 1.7.7 - Improved Error Handling [PR #226](https://jordanbourbonnais.com/pull/226)
...
## ✨ 1.7.6 - Adds Multi-Search Support with Bangs [PR #224](https://jordanbourbonnais.com/pull/224)
- Adds option for user to add custom search bangs, in order to specify search engine/ target app. Re: #206

## 🎨 1.7.5 - Improved Language Detection & UI [PR #223](https://jordanbourbonnais.com/pull/223)
- Makes the auto language detection algo smarter
- Improves responsiveness for the language selector form

## 🌐 1.7.4 - Adds Spanish Translations [PR #222](https://jordanbourbonnais.com/pull/222)
- Adds Spanish language file, contributed by @lu4t

## 👷 1.7.3 - CI with GH Actions [PR #212](https://jordanbourbonnais.com/pull/212)
...
## ✨ 1.7.2 - Item Sort Options [PR #203](https://jordanbourbonnais.com/pull/203)
...
## 🐛 1.7.1 - Lots of Tiny Fixes and Improvements [PR #200](https://jordanbourbonnais.com/pull/201)
...
## 🍻 1.7.0 - Documentation Website [PR #190](https://jordanbourbonnais.com/pull/190)
- Builds a quick website to host the docs. No code changes, but prepares for V1.7 release

## ✨ 1.6.9 - Web Search Feature [PR #185](https://jordanbourbonnais.com/pull/185)
...
## ⚡️ 1.6.8 - Improved Loading Experience [PR #183](https://jordanbourbonnais.com/pull/183)
...
## ⚡️ 1.6.7 - Option for non-SSL status checks plus minor things [PR #182](https://jordanbourbonnais.com/pull/182)
...
## ⚡️ 1.6.6 - Improved Search & Shortcuts [PR #175](https://jordanbourbonnais.com/pull/175)
...
## ✨ 1.6.5 - Adds support for Secure Authentication using Keycloak [PR #174](https://jordanbourbonnais.com/pull/174)
- Major restructure of auth config
- Implements keycloak support, adds docs and updates schema

## ✨ 1.6.4 - Adds functionality for Granular Auth Control [PR #171](https://jordanbourbonnais.com/pull/171)
...
## ⚡️ 1.6.3 - Dependency and Build File Updates [PR #168](https://jordanbourbonnais.com/pull/168)
...
## ✨ 1.6.2 - Support for Guest Access [PR #167](https://jordanbourbonnais.com/pull/167)
...
## 💄 1.6.1 - Adds new Theme [PR #166](https://jordanbourbonnais.com/issues/166)
- Adds Dashy theme, for use in the dev dashboard

## ✨ 1.5.9 - New Minimal/ Startpage View [PR #155](https://jordanbourbonnais.com/issues/155)
...
## ✨ 1.5.8 - Multi-Tasking Support in Workspace View [PR #146](https://jordanbourbonnais.com/pull/146)
...
## ✨ 1.5.7 - Adds Support for Material Design Icons [PR #141](https://jordanbourbonnais.com/pull/141)
...
## ⚡️ 1.5.6 - Refactor + Couple of small things [PR #135](https://jordanbourbonnais.com/pull/135)
...
## 🌐 1.5.5 - Adds Missing Translations + Small UI Issues [PR #129](https://jordanbourbonnais.com/pull/129)
...
## 🐳 1.5.4 - Docker ARM Support [PR #122](https://jordanbourbonnais.com/pull/122)
...
## 🩹 1.5.3 - UI Quick Fix [PR #121](https://jordanbourbonnais.com/pull/121)
...
## 🌐 1.5.2 - Adds Dutch Translations [PR #120](https://jordanbourbonnais.com/pull/120)
- Dutch language support, contributed by @evroon

## 🩹 1.5.1 - UI Quick Fix [PR #116](https://jordanbourbonnais.com/pull/116)
- Uses min-max width parent layout, to prevent longer languages (e.g. French) text overflow. Fixes #115

## 🔒 1.5.0 - Improve Robustness of Auth [PR #113](https://jordanbourbonnais.com/pull/113)
...
## ✨ 1.4.8 - Optional Crash Reports [PR #112](https://jordanbourbonnais.com/pull/112)
...
## ♻️ 1.4.7 - Refactor [PR #110](https://jordanbourbonnais.com/pull/110)
...
## 📝 1.4.6 - Documentation Updates [PR #108](https://jordanbourbonnais.com/pull/108)
...
## 🌐 1.4.5 - Adds German Translations [PR #107](https://jordanbourbonnais.com/pull/107)
- German language support, contributed by @Niklashere

## ✨ 1.4.4 - Adds Support for Logo Image [PR #105](https://jordanbourbonnais.com/pull/105)
- Adds option in config file for user to specify path to an image
- If found, will display said image in the header

## ✨ 1.4.3 - Auto-Checks for Updates [PR #101](https://jordanbourbonnais.com/pull/101) and [PR #102](https://jordanbourbonnais.com/pull/102)
...
## ✨ 1.4.2 - Adds Multi-Language Support [PR #99](https://jordanbourbonnais.com/pull/99)
...
## ✨ 1.4.1 - Adds Support for Custom Key Bindings [PR #94](https://jordanbourbonnais.com/pull/94)
...
## 🔨 1.3.9 - Enable Custom Styesheet in Docker [PR #92](https://jordanbourbonnais.com/pull/92)
- Enables the user to pass a custom stylesheet in with Docker
- Adds support for 1-Click deployment to Render.com

## 🌟 1.3.8 - Showcase [#91](https://jordanbourbonnais.com/pull/91)
- Adds @Shadowking001's screenshot to showcase

## 🌟 1.3.7 - Showcase [PR #84](https://jordanbourbonnais.com/pull/84)
- Adds @dtctek's screenshot to showcase

## ✨ 1.3.6 - Enables User to Hide Unwanted Components [PR #78](https://jordanbourbonnais.com/pull/78)
...
## ✨ 1.3.5 - Adds Support for Emoji Icons [PR #76](https://jordanbourbonnais.com/pull/76)
- Enables user to use emojis for item and section icons
- Adds a handler to convert Unicode, or Shortcode into an Emoji

## 🌟 1.3.4 - Showcase Addition [PR #75](https://jordanbourbonnais.com/pull/75)
- Adds @cerealconyogurt's screenshot to the showcase

## 💄 1.3.3 - UI Improvements [PR #73](https://jordanbourbonnais.com/pull/73)
...
## ⚡️ 1.3.0 - Custom Headers for Status Check [PR #72](https://jordanbourbonnais.com/pull/72)
...
## 🌟 1.2.9 - Creates a Showcase Page [PR #68](https://jordanbourbonnais.com/pull/68)
- Adds a page in the docs for users to share their screenshots of their dashboard

## ✨ 1.2.8 - Adds Remember-Me Functionality into the Login Form [PR #66](https://jordanbourbonnais.com/pull/66)
...
## ✨ 1.2.7 - Implements a Right-Click Context Menu [#62](https://jordanbourbonnais.com/pull/62)
...
## ⚡️ 1.2.6 - Make Font Assets Local [PR #60](https://jordanbourbonnais.com/pull/60)
- Downloaded font files to assets
- Removed all calls to font CDN, replaced with local calls

## 🐛 1.2.5 - Small Fixes, and Efficiency Improvements [PR #57](https://jordanbourbonnais.com/pull/57)
...
## ✨ 1.2.4 - Adds Support for Continuous Status Checking [#52](https://jordanbourbonnais.com/pull/52)
...
## 🐛 1.2.3 - Bug Fix [PR #49](https://jordanbourbonnais.com/pull/49)
...
## 🐛 1.2.1 - Bugfix [#44](https://jordanbourbonnais.com/pull/44)
- Fixes footer positioning on mobile, makes sticky, fixes #42

## ✨ 1.2.0 - Adds Writing Config to Disk from UI Functionality [PR #43](https://jordanbourbonnais.com/pull/43)
...
## 🐛 1.1.8 - Bugfix [#40](https://jordanbourbonnais.com/pull/40)
- Status check tooltip was not visible in Material themes, raised in issue #39

## ✨ 1.1.7 - Adds Workspace View [PR #38](https://jordanbourbonnais.com/pull/38)
...
## ✨ 1.1.6 - Implements Status Indicators, and Monitoring Functionality [PR #34](https://jordanbourbonnais.com/pull/34)
...
## ✨ 1.1.5 - Adds Authentication / Login Functionality [PR #32](https://jordanbourbonnais.com/pull/32)
...
## 💄 1.1.4 - Support for Custom HTML Footer [PR #30](https://jordanbourbonnais.com/pull/30)
- Enables user to insert structure for the footer defined as HTML

## 🚀 1.1.3 - Adds Support for 1-Click Cloud Deployments [PR #29](https://jordanbourbonnais.com/pull/29)
- Support for 1-Click Deploy to Netlify
- Support for 1-Click Deploy to Heroku

## 🔧 1.1.2 - Docker Efficiency Improvements [PR #26](https://jordanbourbonnais.com/pull/26)
...
## 🐛 1.1.1 - Bug Fixes [PR #20](https://jordanbourbonnais.com/pull/20) + [PR #21](https://jordanbourbonnais.com/pull/21)
- Adds issue template
- Bug fixes
...
## 🚑️ 1.1.0 - Hotfix [#18](https://jordanbourbonnais.com/pull/18)
...
## 📝 1.0.5 - Documentation [PR #16](https://jordanbourbonnais.com/pull/16)
...
## ✨ 1.0.0 - Implements Config Validation [PR #13](https://jordanbourbonnais.com/pull/13)
...
## 🔧 0.9.5 - Brand New Docker Container [PR #12](https://jordanbourbonnais.com/pull/12)
...
## ✨ 0.9.0 - Adds Hide Settings Functionality [PR #11](https://jordanbourbonnais.com/pull/11)
...
## 💄 0.8.5 - Adds new Built-In Themes [PR #9](https://jordanbourbonnais.com/pull/9)
...
## ✨ 0.8.0 - Implements Custom CSS Editor [PR: #8](https://jordanbourbonnais.com/pull/8)
...
## ✨ 0.7.5 - Adds Cloud Backup and Restore Feature [PR #6](https://jordanbourbonnais.com/pull/6)
...
## ✨ 0.7.0 - Support for Custom Nav Links [PR #4](https://jordanbourbonnais.com/pull/4)
...
## ✨ 0.6.5 - UI Config Editor [PR #3](https://jordanbourbonnais.com/pull/3)
