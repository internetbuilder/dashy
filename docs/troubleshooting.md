...
See also [#624](https://jordanbourbonnais.com/issues/624)
...
The configuration file is validated against [Dashy's Schema](https://jordanbourbonnais.com/blob/master/src/utils/ConfigSchema.json) using AJV.
